...
const NIGERIA_LOCATIONS = {
  "Abia": [
    ...
    "Isiala Ngwa South", "Isuikwuato", "Oboma Ngwa", "Ohafia", "Osisioma",
    "Ugwunagbo", "Ukwa East", "Ukwa West", "Umu-Nneochi", "Umuahia North", "Umuahia South"
  ],
  "Federal Capital Territory": ["Abaji", "Bwari", "Gwagwalada", "Kuje", "Kwali", "Municipal"],
  "Adamawa": [
    "Demsa", "Fufore", "Ganye", "Girie", "Gombi", "Guyuk", "Hong", "Jada", "Lamurde",
    "Madagali", "Maiha", "Mayo-Belwa", "Michika", "Mubi North", "Mubi South", "Numan",
    "Shelleng", "Song", "Teungo", "Yola North", "Yola South"
  ],
  "Akwa Ibom": [
  ...
  "Bauchi": [
    "Alkaleri", "Bauchi", "Bogoro", "Damban", "Darazo", "Dass", "Gamawa", "Gamjuwa",
  ...
  "Cross River": [
    ...
    "Calabar Municipality", "Calabar South", "Etung", "Ikom", "Obanliku", "Obubra",
    "Obudu", "Odukpani", "Ogoja", "Yakurr", "Yala"
  ],
  "Delta": [
    "AniochaN", "AniochaS", "Bomadi", "Burutu", "Ethiope West", "EthiopeE", "IkaNorth",
    "IkaSouth", "IsokoNor", "IsokoSou", "Ndokwa East", "Ndokwa West", "Okpe",
    "Oshimili North", "Oshimili South", "Patani", "Sapele", "Udu", "Ughelli North",
    "Ughelli South", "Ukwuani", "Uvwie", "Warri North", "Warri South", "Warri South-West"
  ],
  "Ebonyi": [
    "Abakalik", "Afikpo North", "Afikpo South", "Ebonyi", "Ezza North", "Ezza South",
    "Ikwo", "Ishielu", "Ivo", "Izzi", "Ohaozara", "Ohaukwu", "Onicha"
  ],
  "Edo": [
    "Akoko Edo", "Egor", "Esan Centtral", "Esan North East", "Esan South East",
    "Esan West", "Etsako Central", "Etsako East", "Etsako West", "Igueben",
    "Ikpoba-Okha", "Oredo", "Orhionmw", "Ovia North East", "Ovia South West",
    "Owan East", "Owan West", "Uhunmwonde"
  ],
  "Ekiti": [
    "Ado-Ekiti", "Efon", "Ekiti East", "Ekiti South West", "Ekiti West", "Emure",
    "Gboyin", "Ido-Osi", "Ijero", "Ikere", "Ikole", "Ilejemeje", "Irepodun-Ifelodun",
    "Ise-Orun", "Moba", "Oye"
  ],
  "Enugu": [
  ...
  "Gombe": ["Akko", "Balanga", "Billiri", "Dukku", "Funakaye", "Gombe", "Kaltungo", "Kwami", "Nafada", "Shomgom", "Yalmatu / Deba"],
  "Imo": [
    "Aboh-Mbaise", "Ahiazu-Mbaise", "Ehime-Mbano", "Ezinihitte Mbaise", "Ideato North",
    "Ideato South", "Ihitte-Uboma Isinweke", "Ikeduru", "Isiala Mbano", "Isu",
  ...
  "Jigawa": [
    ...
    "Kazaure", "Kirika Samma", "Kiyawa", "Maigatari", "Malam Mado", "Miga", "Ringim",
  ...
  "Kano": [
    ...
    "Takai", "Tarauni", "Tofa", "Tsanyawa", "Tundun Wada", "Ungogo", "Warawa", "Wudil"
  ],
  "Katsina": [
    "Bakori", "Batagarawa", "Batsari", "Baure", "Bindawa", "Charanchi", "Dandume",
    "Danja", "Danmusa", "Daura", "Dutsi", "Dutsin-M", "Faskari", "Funtua", "Ingawa",
    "Jibia", "Kafur", "Kaita", "Kankara", "Kankiya", "Katsina (K)", "Kurfi", "Kusada",
  ...
  "Kebbi": [
    ...
    "Danko Wasagu", "Fakai", "Gwandu", "Jega", "Kalgo", "Koko/Bes", "Maiyama",
    "Ngaski", "Sakaba", "Shanga", "Suru", "Yauri", "Zuru"
  ],
  "Kogi": [
  ...
  "Lagos": [
    "Agege", "Ajeromi/Ifelodun", "Alimosho", "Amuwo Odofin", "Apapa", "Badagary",
  ...
  "Ondo": [
    "Akoko North-East", "Akoko South-East", "Akoko South-West", "AkokoNorthWest",
  ...
  "Osun": [
    ...
    "Ede North", "Ede South", "Egbedore", "Ejigbo", "Ife East", "Ife North", "Ife South",
    "IfeCentral", "Ifedayo", "Ifelodun", "Ila", "Ilesha East", "Ilesha West", "Irepodun",
  ...
  "Plateau": [
    ...
    "Qua'anpa", "Riyom", "Shendam", "Wase"
  ],
  "Rivers": [
    "Abua/Odu", "Ahoada East", "Ahoada West", "Akukutor", "Andoni/Odual", "Asari-Toru",
    "Bonny", "Degema", "Eleme", "Emuoha", "Etche", "Gokana", "Ikwerre", "Khana",
    "Obio/Akpor", "Ogba/Egbema/Andoni", "Ogu/Bolo", "Okrika", "Omumma", "Opobo/Nkoro",
    "Oyigbo", "Port Harcourt", "Tai"
  ],
  "Sokoto": [
    "Binji", "Bodinga", "Dange-Shuni", "Gada", "Goronyo", "Gudu", "Gwadabaw", "Illela",
    "Isa", "Kebbe", "Kware", "Rabah", "Sabon Birni", "Shagari", "Silame", "Sokoto North",
    "Sokoto South", "Tambawal", "Tangazar", "Tureta", "Wamakko", "Wurno", "Yabo"
  ],
  "Taraba": [
  ...
  "Yobe": [
    "Bade", "Borsari", "Damaturu", "Fika", "Fune", "Geidam", "Gujba", "Gulani",
